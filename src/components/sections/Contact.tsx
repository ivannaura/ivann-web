              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-8" noValidate>
                ...
                <div data-reveal>
                  ...
                  <div className="relative">
                    ...
                    <svg className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "var(--text-muted)" }} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
